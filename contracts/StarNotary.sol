...
contract StarNotary is ERC721 {
    ...
    // DONE : symbol: Is a short string like 'USD' -> 'American Dollar'
    ...
    // DONE Implement Task 1 Exchange Stars function
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        require(
            (ownerOf(_tokenId1) == msg.sender) ||
                (ownerOf(_tokenId2) == msg.sender),
            "You can't exchange stars for tokens you dont own"
        );
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        require(
            (ownerOf(_tokenId) == msg.sender),
            "You can't transfer stars for tokens you dont own"
        );
